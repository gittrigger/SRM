...
public class Custom {
	...
	// CUSTOM
	public static String APP = "WhiteHouseFree";
	public static String WHO = "WhiteHouse";
	public static boolean PUBLISH = false;
	public static boolean FREEVERSION = false;
	public static String EMAIL = "info@whitehouse.gov";
	public static int LITTLEICON = R.drawable.usseal;
	public static int TOPICON = R.drawable.whitehousegroup;
	public static String MAINURI = "com.havenskys.whitehousefree";
	public static String BASEURL = "http://www.whitehouse.gov/feed/blog/whitehouse/";
	...
	public void loadlist(listView view) {
		...
		String[] columns = new String[] {"_id", "title", "datetime(date,'localtime') as date", "author", "summary" };
        String[] from = new String[]{"title", "date", "author", "summary" };
        int[] to = new int[]{R.id.listrow_title, R.id.listrow_date, R.id.listrow_author, R.id.listrow_summary };
	...
	public void parseEntries(String who, String httpPage) {
		...
		String[] parseColumns = new String[]{ Custom.TITLE, Custom.LINK, Custom.DATE, Custom.AUTHOR, Custom.SUMMARY, Custom.CONTENT };
		String[] parseTags = new String("title,link href,updated,name,summary,content").split(",");
		int[] parseFixDates = new int[]{};
	...
	public void setEntryNotification(String who, long rowid, int icon, String title, String details, String topscroll){
		...
		Intent intentJump2 = new Intent(mContext, com.havenskys.whitehousefree.Start.class);
	...
	public void setServiceNotification(String who, int icon, String title, String details, String topscroll){
		...
		Intent intentJump = new Intent(mContext, com.havenskys.whitehousefree.Stop.class);
